...
export const FEEDS = [
  ...
  { url: 'https://rss.elconfidencial.com/empresas/',                   source: 'El Confidencial', weight: 7, region: 'Europe' },
  { url: 'https://rss.elconfidencial.com/mercados/',                   source: 'El Confidencial', weight: 6, region: 'Europe' },
  ...
  { url: 'https://www.sec.gov/cgi-bin/browse-edgar?action=getcurrent&type=425&company=&dateb=&owner=include&count=60&output=atom', source: 'SEC EDGAR (M&A)', weight: 7, region: 'North America' },
  { url: 'https://www.pehub.com/feed/',                                source: 'PE Hub', weight: 7, region: 'Global' },
  { url: 'https://petition.substack.com/feed',                         source: 'PETITION', weight: 8, region: 'Global' },
  ...
  { url: 'https://www.google.com/alerts/feeds/06105068407501071303/4700801285959862994', source: 'Pepe Bravo (Expansion)', weight: 10, region: 'Europe' },
  // Capital riesgo / private equity Espana, via Google Alert (RSS).
  { url: 'https://www.google.com/alerts/feeds/06105068407501071303/2410262124568547512', source: 'Alertas PE Espana', weight: 8, region: 'Europe' },
  // Reporteros que rompen deals (Bloomberg/Reuters/Axios/FT), via Google Alert (RSS). Capa de exclusivas.
  { url: 'https://www.google.com/alerts/feeds/06105068407501071303/8306144659331516214', source: 'Deal Reporters', weight: 9, region: 'Global' },
  { url: 'https://www.gov.uk/government/organisations/competition-and-markets-authority.atom', source: 'CMA', weight: 6, region: 'Europe' },
  { url: 'https://ec.europa.eu/commission/presscorner/api/rss?language=en&text=merger', source: 'European Commission', weight: 6, region: 'Europe' },
  { url: 'https://www.jdsupra.com/legalnews/mergers-acquisitions/rss/', source: 'JD Supra', weight: 5, region: 'Global' },
