...
export default async function handler(req, res) {
  ...
  try {
    ...
    const message = await client.messages.create({
      ...
      messages: [{
        role: 'user',
        content: `You are a sharp M&A analyst writing editorial commentary for MERIDIAN, a premium capital markets publication. Write a concise 3-paragraph analysis (no headers, flowing prose) of this deal. Be direct, use precise financial language, surface what the deal signals about broader market dynamics.
