...
const SERVICES = [
  ...
  {
    id: 'pf', n: '03', t: 'Project Finance',
    lead: 'Structuring long-dated financing for infrastructure and energy assets, built around what lenders and investors will actually underwrite.',
    left: { h: 'Assets', items: ['Renewable generation and storage', 'Grid and energy infrastructure', 'Transport and social infrastructure', 'Concessions and availability-based assets', 'Portfolio and platform financings'] },
    right: { h: 'What we do', items: ['Full project financial modelling and sensitivity analysis', 'Bankability review of contracts, offtake and permits', 'Debt sizing, tenor and covenant structuring', 'Lender and investor outreach and process management', 'Support through credit approval to financial close'] },
  },
];
...
export default function Services() {
  return (
    <>
      <Head>
        <title>Services &mdash; M&amp;A, Debt Advisory, Project Finance | Meridian</title>
        <meta name="description" content="M&A, debt advisory and project finance services for companies, shareholders and sponsors across Iberia." />
        <link rel="canonical" href="https://www.meridiancapmarkets.com/services" />
      </Head>
      <Layout>
        <PageHero
          eyebrow="Services"
          title="Three disciplines, executed properly."
          sub="Transactions between 30 million and 1 billion euros, with a focus on the Iberian energy, TMT and infrastructure sectors."
        />
