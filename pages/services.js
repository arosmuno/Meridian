...
const FAQ = [
  { q: 'How are you paid?',
    a: 'A retainer equal to 15% of the success fee, and a success fee of 3% of the transaction value. The retainer covers the preparation work that happens before anything is marketed; the bulk of the economics only arrives if the transaction closes.' },
  { q: 'How long does a sale process take?',
    a: 'Eight to twelve months from mandate to completion is a realistic range for a prepared mid-market business. Poorly prepared processes take longer or fail, which is why preparation is a distinct stage rather than something done in parallel with marketing.' },
