...
// Colapsa noticias duplicadas (misma operacion re-titulada por distintas fuentes/pasadas del
// cron). Dos vias: (1) par buyer|target normalizado identico (tolera intercambio de roles);
