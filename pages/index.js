...
const STATS = [
  { n: '5', l: 'Years in investment banking' },
  { n: '2', l: 'Global banks: BBVA, BNP Paribas' },
  { n: '30m–1bn', l: 'Transaction size range (EUR)' },
  { n: 'Iberia', l: 'Energy, TMT, infrastructure' },
];
        ...
        <section className="sec dark">
          <div className="wrap">
            <div className="sec-head">
              ...
              <h2 className="h2">Built on institutional experience.</h2>
        ...
        <section className="sec alt">
          <div className="wrap g2 offset">
            <div>
              ...
              <h2 className="h2" style={{ marginTop: 18 }}>We track the European deal market, in public.</h2>
              ...
              <div style={{ marginTop: 36 }}>
                <Link href="/intelligence" className="btn btn-solid">View the deal record <span>&rarr;</span></Link>
              </div>
            </div>
            <div className="stat">
              <div className="stat-num">Daily</div>
              <div className="stat-lbl">Updated from primary sources</div>
              <ul className="ticks" style={{ marginTop: 40 }}>
                <li>Every entry linked to its original publication</li>
                <li>Structured by type, sector and value</li>
