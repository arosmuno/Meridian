  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Contact Meridian Capital Markets to discuss an M&A, debt advisory or project finance situation." />
        ...
        <section className="sec">
          <div className="wrap g2">
            ...
            <div style={{ borderLeft: '1px solid var(--line)', paddingLeft: 40 }}>
              ...
              <p className="body" style={{ marginTop: 14, fontSize: 15 }}>
                For corrections, omissions or tips relating to the Market Intelligence record, use the same
