    ...
    <>
      ...
      <Layout>
        <PageHero
          ...
          sub="A newly established practice, bringing institutional transaction discipline to mid-market situations that rarely receive it."
        />
        ...
        <section className="sec">
          <div className="wrap g2">
            <div>
              ...
              <hr className="rule" />
              <p className="body">
                Alberto is a corporate and investment banking professional. He spent five years at BBVA and
                BNP Paribas, across client coverage, capital markets and transaction origination, before
                founding Meridian.
              </p>
              <p className="body">
                In those roles he worked on M&amp;A and leveraged finance transactions in the Iberian energy
                and TMT sectors, as part of deal teams. The work covered financial modelling, valuation
                analysis using comparable companies and precedent transactions, and the coordination of due
                diligence across legal, financial and technical advisers.
              </p>
              <p className="body">
            ...
            <div style={{ borderLeft: '1px solid var(--line)', paddingLeft: 40 }}>
              ...
              <ul className="ticks" style={{ marginTop: 24 }}>
                ...
                <li>M&amp;A and leveraged finance</li>
                <li>Iberian energy and TMT</li>
              ...
              <p className="small" style={{ marginTop: 26 }}>
                This is the founder&apos;s personal professional background, gained as an employee of the
                institutions named and as part of their deal teams. It is not a record of transactions
                executed by Meridian, and it is not presented as one. Meridian is a newly established
                practice and does not yet publish a track record.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="sec alt">
          <div className="wrap">
            <div style={{ maxWidth: 760 }}>
              ...
              <hr className="rule" />
              <p className="body">
                Meridian publishes daily news coverage of European transaction activity. It is compiled
              ...
              <div style={{ marginTop: 30 }}>
                <Link href="/intelligence" className="btn btn-ghost">See the news coverage</Link>
              </div>
            </div>
          </div>
        </section>
